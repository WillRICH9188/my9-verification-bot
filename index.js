...
const LANG = {
  en: {
    welcome: '🔐 This service is for verified users aged 18 and above.\nPlease confirm to proceed.',
    agree: '✅ Yes, I am 18+ and agree',
    ask_game_id: '📨 Kindly enter your member code or access ID:',
    done: (link) => `✅ Verified! You may now proceed to the next step:\n👉 ${link}`
  },
  hi: {
    welcome: '🔐 यह सेवा केवल 18+ सत्यापित उपयोगकर्ताओं के लिए है।\nकृपया जारी रखने के लिए पुष्टि करें।',
    agree: '✅ हाँ, मैं 18+ हूँ और सहमत हूँ',
    ask_game_id: '📨 कृपया अपना सदस्य कोड या एक्सेस आईडी दर्ज करें:',
    done: (link) => `✅ सत्यापित! अब आप अगले चरण पर जा सकते हैं:\n👉 ${link}`
  }
};
